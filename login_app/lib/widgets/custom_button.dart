...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({super.key, required this.text, required this.onPressed, this.isFullWidth, this.color = Colors.white, this.backgroundColor = Colors.lightGreen});
